...
import { 
  ...
  Sparkles, Target, LineChart, PlayCircle, ArrowDown, Sliders, Check, Lock, ChevronRight, Plus, X
} from 'lucide-react'
...
const FAQS = [
  { q: "What Is Scalely.ai, And What Does It Offer?", a: "Scalely.ai is a performance affiliate marketing platform that allows you to easily connect with high-converting offers, copy proven strategies from top earners, and track your metrics in real-time." },
  { q: "How Do I Get Started With Scalely.ai?", a: "Getting started is easy! Create a free account in under two minutes, browse our directory of verified affiliate partners, and start copying their successful campaigns instantly." },
  { q: "What Sets Scalely.ai Apart From Other Affiliate Marketing Platforms?", a: "Unlike traditional platforms, Scalely.ai provides full transparency into partner returns, automated AI optimization, and a unique copy-trading model applied to affiliate marketing." },
  { q: "What Is The Referral Program, And How Does It Work?", a: "Our referral program rewards you for bringing other affiliates to the platform. You earn a percentage of the revenue generated by anyone who signs up using your unique referral link." },
  { q: "Can I Withdraw My Earnings, And How Does It Work?", a: "Yes, you can withdraw your earnings at any time. We support multiple withdrawal methods including crypto and wire transfers, with most payouts processed in under 48 hours." },
]
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#EFF2F0] text-slate-900 font-sans">
      ...
      {/* ── WHO WE ARE / MISSION (PREMIUM REDESIGN) ── */}
      <section className="py-24 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-[#004235] to-[#00261c] rounded-[40px] sm:rounded-[56px] p-8 sm:p-16 border border-white/10 shadow-2xl relative overflow-hidden text-white grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* Glow Orb */}
          <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-[#C3F53C]/10 rounded-full blur-[120px] pointer-events-none" />
          <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] bg-emerald-500/10 rounded-full blur-[100px] pointer-events-none" />

          {/* Left Column: Mission Story */}
          <div className="lg:col-span-7 space-y-8 text-left relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-emerald-300 text-[10px] sm:text-xs font-bold uppercase tracking-widest backdrop-blur-sm shadow-sm">
            ...
            <div className="pt-4">
              <Link to="/signup" className="group inline-flex items-center gap-3 bg-[#C3F53C] text-[#004235] text-sm font-extrabold px-8 py-4 rounded-xl shadow-[0_0_40px_-10px_rgba(195,245,60,0.3)] hover:bg-[#aeda20] hover:shadow-[0_0_60px_-15px_rgba(195,245,60,0.5)] transition-all duration-300">
                Start Earning With Us <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Link>
            </div>
          </div>
      ...
      {/* ── FOOTER CTA ── */}
      <section className="bg-[#005645] rounded-t-[48px] sm:rounded-t-[64px] text-white pt-20 pb-12 mt-0 shadow-2xl">
