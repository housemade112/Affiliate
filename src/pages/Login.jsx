    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white flex items-center justify-center px-4 py-12 relative overflow-hidden font-sans">
      ...
      <div className="relative w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="text-2xl font-extrabold text-white tracking-tight pt-2">Welcome Back</h1>
          <p className="text-xs text-slate-400 font-mono">Sign in to your Scalely.ai account console</p>
        </div>
        ...
        <div className="bg-neutral-900 border border-neutral-800 p-8 rounded-3xl shadow-xl space-y-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button 
              type="button" 
              onClick={() => { login('alex.morgan@scalely.ai', 'demo'); addToast('Instant Demo Access granted!', 'success'); navigate('/dashboard') }}
          ...
          <div className="pt-4 border-t border-neutral-800 text-center">
            <p className="text-xs text-slate-400">
              ...
              <Link to="/signup" className="text-[#C3F53C] font-bold hover:underline">
                Create one free
              </Link>
            </p>
          </div>
